...
class Storage(models.Model):
    ...
    code_projet = models.CharField(blank=True)
    nom_projet = models.CharField(blank=True)
    client_name = models.CharField(blank=True)
    site_location = models.IntegerField(blank=True, default=0)
